...
import { dummyUser } from './common/dummy/user.data';
import { dummyRestaurants } from './common/dummy/restaurants.data';
import { dummyProductCategories } from './common/dummy/products.data';
import { Product } from './product/entities/product.entity';
import { dummyReviews } from './common/dummy/reviews.data';
